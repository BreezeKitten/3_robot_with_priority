...
resTH = PI/15
LOG_DIR = 'logs/Residual_Learning_midLayer/400_200_200_100_tanh'
SOME_TAG = '_Nothing'
...
test_num = 1
Network_Path = '2_to_3_robot_network/Residual_network_midLayer/400_200_200_100_tanh'
...
if __name__ == '__main__':
    ...
    with tf.name_scope('2_to_3_NW'):
        ...
        predict_value, mWf, mBf = add_layer(mH4, m_layer4_output_number, 1, 'mWf', 'mBf', activation_function=None)
        two_to_three_network_saver = tf.train.Saver({'mW1':mW1,'mW2':mW2,'mW3':mW3,'mW4':mW4,'mWf':mWf,
                            'mB1':mB1,'mB2':mB2,'mB3':mB3,'mB4':mB4,'mBf':mBf})
   
    Final_predict_value = tf.nn.tanh(predict_value + nearest_value)
